...
export default function AMP() {
  return (
    <div>
      ...
      <div>
        <div className='images_AMP'>
          <div className='box_AMP'>
      ...
      <div id="all_grid">
            ...
            <div class="white_back">
                ...
                <button> <Link to ='/OneWeekAthleticMealPlan' >Order Now</Link>  </button>
            ...
            <div  className="white_back">
                ...
                <button><Link to ='/TwoWeekAthleticMealPlan' >Order Now</Link> </button>
            </div>
           <div   className="white_back">
                ...
                <button><Link to ='/ThreeWeekAthleticMealPlan' >Order Now</Link> </button>
            </div>
        </div>
      </div>
