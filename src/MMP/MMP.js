...
export default function MMP() {
  return (
    <div>
      ...
      <div>
        <div className='images_MMP'>
          <div className='box_MMP'>
      ...
      <div id="all_grid">
            ...
            <div class="white_back">
                ...
                <button> <Link to ='/OneWeekMMP' >Order Now</Link>  </button>
            ...
            <div  className="white_back">
                ...
                <button> <Link to ='/TwoWeekMMP' >Order Now</Link> </button>
            </div>
           <div   className="white_back">
                ...
                <button><Link to ='/ThreeWeekMMP' >Order Now</Link></button>
            </div>
        </div>
      </div>
