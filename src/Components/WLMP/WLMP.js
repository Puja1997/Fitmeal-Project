...
import './WLMP.css'
export default function WLMP() {
  return (
    <div>

      <div>
        <div className='images_WLMP'>
          <div className='box_WLMP'>
      ...
      <div id="all_grid">
            ...
            <div class="white_back">
                ...
                <button> <Link to ='/OneWeekWeightLossPlan' >Order Now</Link>  </button>
            ...
            <div  className="white_back">
                ...
                <button><Link to ='/TwoWeekWeightLossPlan' >Order Now</Link> </button>
            </div>
           <div   className="white_back">
                ...
                <button><Link to ='/ThreeWeekWeightLossPlan' >Order Now</Link> </button>
            </div>
        </div>
      </div>
