...
import './OneWeekKMP.css';

export default function OneWeekKMP() {
      ...
      <div>
        <div>
          <div id="pro_details" className="open">
            <img src="https://www.fitmeals.co.in/wp-content/uploads/2021/05/IMG_0148.jpg" />
            <div id="form_submit">
              <p>₹0.00</p>
