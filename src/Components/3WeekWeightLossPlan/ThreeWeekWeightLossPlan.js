...
import './ThreeWeekWeightLossPlan.css';
...
export default function ThreeWeekWeightLossPlan() {
  ...
  return (
    <div>
      ...
      <div className='images_lossplan_TRWWLP'>
        <div className='box_lossplan_TRWWLP'>
      ...
      <div>
        <div>
          <div id="pro_details" className="open">
            <img src="https://www.fitmeals.co.in/wp-content/uploads/2021/05/131656388_2928339300783531_1455339526998620196_n-550x523.jpg" />
            <div id="form_submit">
              <p>{"₹"+total}</p>
