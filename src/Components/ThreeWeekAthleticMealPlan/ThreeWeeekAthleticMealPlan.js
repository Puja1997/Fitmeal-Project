...
import './ThreeWeekAthletikMealPlan.css';
...
export default function ThreeWeekAthleticMealPlan() {
  ...
  return (
    <div>
      ...
      <div className='images_lossplan_TRAMP'>
        <div className='box_lossplan_TRAMP'>
