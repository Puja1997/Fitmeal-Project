...
import './ThreeWeekMMP.css';

export default function ThreeWeekMMP() {
  ...
  return (
    <div>
      ...
      <div className='images_lossplanFour'>
        <div className='box_lossplanFour'>
      ...
      <div>
        <div>
          <div id="pro_details" className="open">
            <img src="https://www.fitmeals.co.in/wp-content/uploads/2021/05/unnamed-6-550x527.jpg" />
            <div id="form_submit">
              <p>₹0.00</p>
